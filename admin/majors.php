...
<head>
    ...
    <title>Quản lý ngành học đề xuất</title>
...
<body>
    <div class="container">
        <h2>Quản lý ngành học đề xuất phù hợp MBTI</h2>
        <div class="action-bar">
            <div class="left-actions">
                ...
                <form id="search-form" style="display: inline-flex; gap: 8px; align-items: center;">
                    ...
                    <select name="search_by" required>
                        ...
                        <option value="major_name">Tên</option>
                    </select>
            ...
            <a href="actions/form.php?table=majors" class="btn-add-new ajax-link">
                 Thêm mới
            </a>
        </div>
        <table>
            ...
            <tbody>
                ...
                $sql = "SELECT * FROM majors ORDER BY major_id DESC";
                ...
                ?>
                        <tr>
                            <td><input type="checkbox" name="selected[]" value="<?php echo $row['major_id']; ?>" class="checkbox"></td>
                            <td><?php echo $stt++; ?></td>
                            <td><?php echo $row['major_id']; ?></td>
                            <td><?php echo htmlspecialchars($row['major_name']); ?></td>
                            <td><?php echo htmlspecialchars($row['description']); ?></td>
                            <td class="text-center actions">
                                <a href="actions/form.php?id=<?php echo $row['major_id']; ?>&table=majors&id_column=major_id" title="Sửa" class="edit-btn ajax-link ">
                                    <i class="fas fa-edit"></i>
                                </a>
                                <a href="actions/delete.php?id=<?= $row['major_id'] ?>&table=majors&id_column=major_id&mode=redirect" title="Xóa" class="delete-btn ajax-link" data-confirm="Bạn có chắc chắn muốn xóa không?">
