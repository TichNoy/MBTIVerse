        ...
        <div class="action-bar">
            <div class="left-actions">
                ...
                <form id="search-form" style="display: inline-flex; gap: 8px; align-items: center;">
                    ...
                    <input type="hidden" name="table" value="questions">
                    <button type="submit">Tìm</button>
                    <button type="button" id="reset-btn">Đặt lại</button>
                </form>
            </div>
            <a href="actions/form.php?table=questions" class="btn-add-new ajax-link">
                Thêm mới
            </a>
        </div>
        <table>
            <thead>
                <tr>
                    ...
                    <th>Danh mục</th>
                    <th>Chiều hướng ngoại cảnh</th>
                    <th>Chiều hướng nội tâm</th>
            ...
            <tbody>
                ...
                ?>
                        <tr>
                            <td><input type="checkbox" name="selected[]" value="<?php echo $row['question_id']; ?>" class="checkbox "></td>
                            <td><?php echo $stt++; ?></td>
                            <td><?php echo $row['question_id']; ?></td>
                            <td><?php echo htmlspecialchars($row['question_text']); ?></td>
                            <td><?php echo $row['category']; ?></td>
                            <td><?php echo $row['trait_positive']; ?></td>
                            <td><?php echo $row['trait_negative']; ?></td>
                            <td class="text-center actions">
                                <a href="actions/form.php?id=<?php echo $row['question_id']; ?>&table=questions&id_column=question_id" title="Sửa" class="edit-btn ajax-link">
                                    <i class="fas fa-edit"></i>
                                </a>
                                <a href="actions/delete.php?id=<?php echo $row['question_id']; ?>&table=questions&id_column=question_id&mode=redirect" title="Xóa" class="delete-btn ajax-link " data-confirm="Bạn có chắc chắn muốn xóa không?">
                ...
                <?php
                    ...
                    echo "<tr><td colspan='9' class='text-center'>Không có câu hỏi nào trong database.</td></tr>";
                }
